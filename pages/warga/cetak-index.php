...
class PDF extends FPDF
{
    ...
    {
      // Logo
      $this->Image('../../assets/img/alfa.jpg',0,5);
    	...
    	// $this->Cell(60);
    	// Title
        $this->Cell(308,8,'ALFAMART BINTARO TERRACE 2',0,1,'C');
        $this->Cell(308,8,'JL.KASUARI BLOCK HB 6, NO 01, BINTARO SEKTOR IX, PONDOK PUCUNG, PONDOK AREN',0,1,'C');
    	$this->Cell(308,8,'TANGERANG SELATAN',0,1,'C');
    	// Line break
    	$this->Ln(5);
        ...
        $this->Cell(308,8,'LAPORAN DATA KARYAWAN',0,1,'C');
        $this->Ln(5);
        ...
        $this->cell(25,7,'PENDIDIKAN',1,0,'C');
        $this->cell(30,7,'PEKERJAAN SBLM',1,0,'C');
...
foreach ($data_warga as $warga) {
    ...
    $pdf->cell(40, 7, substr(strtoupper($warga['nama_warga']),0 , 17), 1, 0, 'C');
    $pdf->cell(35, 7, strtoupper($warga['tempat_lahir_warga']), 1, 0, 'C');
    ...
    $pdf->cell(40, 7, substr(strtoupper($warga['alamat_warga']), 0, 20), 1, 0, 'C');
    ...
    $pdf->cell(25, 7, strtoupper($warga['pendidikan_terakhir_warga']), 1, 0, 'C');
